...
namespace apichipper.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetTemperature = table.Column<string>(type: "text", nullable: false),
                    Humidity = table.Column<string>(type: "text", nullable: false),
                    TargetHumidity = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CurrentEnvironments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CurrentEnvironments_Zones_ZoneId",
                        column: x => x.ZoneId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CurrentEnvironments_ZoneId",
                table: "CurrentEnvironments",
                column: "ZoneId");
